...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Models.Stanar", b =>
                {
                    ...
                    b.Property<int?>("NezainteresovaniStanari")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("StanariProtiv")
                        .HasColumnType("int");

                    b.Property<int?>("StanariZa")
                        .HasColumnType("int");

                    b.Property<string>("Status")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("ZainteresovaniStanari")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("NezainteresovaniStanari");

                    b.HasIndex("StanRefID");

                    b.HasIndex("StanariProtiv");

                    b.HasIndex("StanariZa");

                    b.HasIndex("ZainteresovaniStanari");
            ...
            modelBuilder.Entity("backend.Models.Stanar", b =>
                {
                    b.HasOne("backend.Models.Sastanak", null)
                        .WithMany("NezainteresovaniStanari")
                        .HasForeignKey("NezainteresovaniStanari");

                    b.HasOne("backend.Models.Stan", "StanRef")
                        .WithMany("StanariRef")
                        .HasForeignKey("StanRefID");

                    b.HasOne("backend.Models.Predlog", null)
                        .WithMany("StanariProtiv")
                        .HasForeignKey("StanariProtiv");

                    b.HasOne("backend.Models.Predlog", null)
                        .WithMany("StanariZa")
                        .HasForeignKey("StanariZa");

                    b.HasOne("backend.Models.Sastanak", null)
                        .WithMany("ZainteresovaniStanari")
                        .HasForeignKey("ZainteresovaniStanari");
            ...
            modelBuilder.Entity("backend.Models.Predlog", b =>
                {
                    b.Navigation("StanariProtiv");

                    b.Navigation("StanariZa");
                });

            modelBuilder.Entity("backend.Models.Sastanak", b =>
                {
                    b.Navigation("NezainteresovaniStanari");

                    b.Navigation("ZainteresovaniStanari");
                });
