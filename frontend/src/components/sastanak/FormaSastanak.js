...
export default function FormSastanak(props){
    ...
    async function  handleSubmit(e){
        ...
        console.log(content);
        props.dispatch({type:ACTIONS.NOVI_SASTANAK, payload:{id:content.id,povod: povod,vreme:new Date(vreme).toLocaleString(),mesto: mesto,brojZainteresovanih:0,brojNezainteresovanih:0}})
        props.setForm(false);
